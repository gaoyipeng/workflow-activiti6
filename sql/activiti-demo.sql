...
CREATE TABLE `oa_leave`  (
  ...
  `leave_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '请假类型',
  `process_instance_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '流程实例id',
  `reality_end_time` datetime(0) DEFAULT NULL COMMENT '真实请假结束时间',
  `reality_start_time` datetime(0) DEFAULT NULL COMMENT '真实请假开始时间',
...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('activiti-rest', 'activiti-rest,activiti-web,activiti-auth', '$2a$10$RwjayO3IOpr0L8t8We2YC.FoEodRUQJowNPsOOKmkF8hZ4Mfn/V8y', 'ROLE_ADMIN,ROLE_USER,ROLE_API', 'client_credentials,password,authorization_code,implicit,refresh_token', 'https://www.baidu.com', NULL, 7200, 259200, NULL, '2020-10-05 19:57:03', 0, 0, 'true');
INSERT INTO `oauth_client_details` VALUES ('activiti-web', 'activiti-rest,activiti-web,activiti-auth', '$2a$10$RwjayO3IOpr0L8t8We2YC.FoEodRUQJowNPsOOKmkF8hZ4Mfn/V8y', 'ROLE_ADMIN,ROLE_USER,ROLE_API', 'client_credentials,password,authorization_code,implicit,refresh_token', 'https://www.baidu.com', NULL, 7200, 259200, NULL, '2020-10-05 19:57:05', 0, 0, 'true');
