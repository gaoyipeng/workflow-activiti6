package com.sxdx.workflow.auth.util;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/workflow-auth/src/main/java");
        ...
        gc.setFileOverride(true);//再次生产是否覆盖原文件
        ...
        pc.setParent("com.sxdx.workflow.auth");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/workflow-auth/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
